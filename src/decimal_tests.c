...
START_TEST(s21_add_0) {
  s21_decimal src1, src2, *result = NULL;
...
START_TEST(s21_add_53) {
  ...
  src1.bits[1] = 0b00000000000000000000000000000000;
  src1.bits[2] = 0b00000000000000000000000000000000;
  src1.bits[3] = 0b00111111000000000001111111111100;
  src2.bits[0] = 0b00000000000000000000000000000000;
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000000000000000000000000;
...
START_TEST(s21_add_54) {
  ...
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00111111000000000001111111111100;
  value_type_result = s21_add(src1, src2, &result);
  value_type_origin = 1;
  ck_assert_int_eq(value_type_result, value_type_origin);
}
...
START_TEST(s21_add_55) {
  ...
  src2.bits[0] = 0b00000000000000000000000000111111;
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000000000000000000000000;
  value_type_result = s21_add(src1, src2, &result);
...
START_TEST(dec_to_int_0) {
  ...
  src.bits[1] = 0b00000000000000000000000000000000;
  src.bits[2] = 0b00000000000000000000000000000000;
  src.bits[3] = 0b00000000001111110000000000000000;
  int result = 0;
  int origin_error = 1;
...
START_TEST(dec_to_int_22) {
  s21_decimal src;
  src.bits[0] = 0b00000000000000000000000000000000;
  src.bits[1] = 0b00001111111111111111000000000000;
  src.bits[2] = 0b00000000000000000000000000000000;
  src.bits[3] = 0b00000000000000000000000000000000;
  int result = 0;
  int origin_error = 1;
...
START_TEST(dec_to_int_26) {
  ...
  src.bits[1] = 0b00000000000000000000000000000000;
  src.bits[2] = 0b00000000000000000000000000000000;
  src.bits[3] = 0b10011110000000000000111111100000;
  int result = 0;
  int origin_error = 1;
  int my_error = s21_from_decimal_to_int(src, &result);
  ck_assert_int_eq(origin_error, my_error);
...
START_TEST(s21_from_float_to_decimal_4) {
  s21_decimal val;
  s21_from_float_to_decimal(9999E+20F, &val);
  ck_assert_int_eq(val.bits[0], 0b00111101111100000000000000000000);
  ck_assert_int_eq(val.bits[1], 0b10110000000001110110111011000000);
  ck_assert_int_eq(val.bits[2], 0b00000000000000001101001110111100);
  ck_assert_int_eq(val.bits[3], 0);
}
END_TEST
...
void srunner_add_cast_tests(SRunner *sr) {
  ...
  tcase_add_test(tc1_1, dec_to_int_22);
